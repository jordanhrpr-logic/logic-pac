  ...
  return (
    <>
      ...
      <div className="blog-body">
            ...
            <p><strong>California SB 54</strong> establishes an extended producer responsibility program for covered packaging and statewide source-reduction, recycling, and recyclability or compostability goals. It does not create one universal PCR percentage for every beauty package. Brands should document each component and confirm current CalRecycle requirements for their covered-material categories.</p>
      ...
      <BlogFAQ
        ...
        faqs={[
          ...
          { question: 'How do California SB 54 and EU PPWR affect beauty packaging materials?', answer: 'California SB 54 establishes an EPR program and statewide packaging goals; obligations depend on the producer and covered-material category. EU PPWR sets phased recyclability and recycled-content rules with percentages that vary by packaging type, including different treatment for contact-sensitive PET and other plastics. Brands should classify each component before setting a material specification.' },
        ]}
