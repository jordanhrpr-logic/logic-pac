    ...
    <>
      ...
      <ScrollReveal className="gprev">
        ...
        <div className="ggrid">
          ...
          <Link href="/work" className="ge ge-b" style={{ background: 'linear-gradient(135deg,#0f2027,#2c5364)' }}><Image src="/images/portfolio/skincare-launch-pr-mailer.jpg" alt="Skincare Launch PR Mailer — influencer kit by Logic Pac" fill style={{ objectFit: 'cover', objectPosition: 'center 90%' }} sizes="(max-width: 768px) 100vw, 33vw" /><div className="geov"><div className="gecat">Influencer Kits</div><div className="genm">Skincare Launch PR Mailer</div></div></Link>
